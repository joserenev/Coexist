...
function Login(props) {
    ...
    const handleSignUp = async () => {
      ...
      //let that = this;
              ...
              let response = (await Authentication.signUp(loginValue, passwordValue,
                                                          emailValue)
                              .catch(function (err) {
                                  // that.setState({
                                  //     showResponse: true,
    ...
    return (
      <Grid container className={classes.container}>
        <div className={classes.logotypeContainer}>
          ...
          <Typography className={classes.logotypeText}>Coexist</Typography>
        </div>
                  ...
                  <div className={classes.creatingButtonContainer}>
                    {isLoading ? (
                      ...
                      <Button
                        ...
                        disabled={
                          confirmationCodeValue.length === 0
                        }
                        size="large"
                        variant="contained"
                        color="primary"
